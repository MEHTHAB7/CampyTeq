...
from common.permissions import IsSuperAdmin, IsTenantMember
...
class CollegeViewSet(viewsets.ModelViewSet):
    ...
    Only Super Admins can create or list all colleges.
    Regular tenant users can only access their current college profile.
    """
    ...
    def current(self, request):
        ...
        if not request.user.college:
            if request.user.role == 'SUPER_ADMIN':
                # Super Admin without assigned college gets first active or none
